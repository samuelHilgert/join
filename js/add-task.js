...
function showSuccessMessage() {
  ...
  successMessage.innerHTML = showSuccessMessageHTML();
}

function showSuccessMessageHTML() {
  return `
  <div class="task-success d_f_c_c">
      <div class="task-success-input gap-10">
        <span class="task-success-span">Task added to board</span>
        <svg class="task-success-svg" xmlns="http://www.w3.org/2000/svg">
          <path
